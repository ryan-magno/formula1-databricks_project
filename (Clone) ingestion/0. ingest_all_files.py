...
v_result = dbutils.notebook.run("7. ingest_lap_times_folder", 0, {"p_data_source": "Ergast API"})

v_result

# COMMAND ----------

v_result = dbutils.notebook.run("8. ingest_qualifying_folder", 0, {"p_data_source": "Ergast API"})
